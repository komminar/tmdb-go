...
func TestRenderFacade(t *testing.T) {
	...
	t.Run("single tag", func(t *testing.T) {
		...
		assert.Contains(t, s, `"github.com/komminar/tmdb-go/movie"`)
	...
	t.Run("multiple tags preserve order and title-case fields", func(t *testing.T) {
		...
		s := string(out)
		assert.Contains(t, s, `"github.com/komminar/tmdb-go/account"`)
		assert.Contains(t, s, `"github.com/komminar/tmdb-go/tv"`)
	...
	t.Run("empty tag list produces a valid (empty) Client", func(t *testing.T) {
		...
		assert.NotContains(t, s, `"github.com/komminar/tmdb-go/`)
	})
